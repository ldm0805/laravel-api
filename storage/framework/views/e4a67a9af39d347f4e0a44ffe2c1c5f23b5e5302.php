...
unset($__errorArgs, $__bag); ?>" id="cover_image" name="cover_image">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group mb-3">
                ...
                <div class="form-check <?php $__errorArgs = ['tags'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                    ...
                    <input class="form-check-input" type="checkbox" value=<?php echo e($tag->id); ?> name="tags[]"> 
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\MAMP\htdocs\laravel\laravel_vite\laravel-api\resources\views/admin/projects/create.blade.php ENDPATH**/ ?>